...
defold.support = {}
defold.support.Script = _hx_empty() local Coin = _hx_empty() local Controller = _hx_empty() local Date = _hx_empty() local Ground = _hx_empty() local Hero = _hx_empty() local Math = _hx_empty() local Messages = _hx_empty() local Platform = _hx_empty() local Reflect = _hx_empty() local String = _hx_empty() local Std = _hx_empty() local StringBuf = _hx_empty() defold.GoMessages = _hx_empty() defold.PhysicsMessages = _hx_empty() defold.SpineMessages = _hx_empty() defold.types = {}
