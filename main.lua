...
Coin.prototype.init = function(self,data) 
  data.collected = false;
end
Coin.prototype.on_message = function(self,data,message_id,message,sender) 
...
Coin.__super__ = __defold_support_Script
setmetatable(Coin.prototype,{__index=__defold_support_Script.prototype})
...
Controller.prototype.on_message = function(self,data,message_id,message,sender) 
  local message_id1 = message_id;
  if (message_id1) == Messages.DeleteSpawn then 
    __lua_PairTools.ipairsEach(data.spawns, function(i,p) 
  ...
  elseif (message_id1) == Messages.Reset then 
    ...
    __lua_PairTools.ipairsEach(data.spawns, function(i1,p1) 
      _G.go.delete(p1);
    end);
    data.spawns = ({}); end;
end
...
Ground.prototype.init = function(self,data) 
  data.speed = 6;
end
Ground.prototype.update = function(self,data,dt) 
  local _g = 0;
...
Ground.prototype.on_message = function(self,data,message_id,message,sender) 
  if (message_id == Messages.SetSpeed) then 
    data.speed = _hx_funcToField(message.speed);
  end;
end
Ground.__super__ = __defold_support_Script
setmetatable(Ground.prototype,{__index=__defold_support_Script.prototype})
...
Hero.prototype.play_animation = function(self,data,anim) 
  if (data.anim ~= anim) then 
    _G.spine.play("#spinemodel", anim, _G.go.PLAYBACK_LOOP_FORWARD, 0.15);
    data.anim = anim;
  end;
end
Hero.prototype.update_animation = function(self,data) 
...
Hero.prototype.handle_geometry_contact = function(self,data,normal,distance) 
...
Hero.prototype.on_message = function(self,data,message_id,message,sender) 
...
Hero.prototype.on_input = function(self,data,action_id,action) 
...
Hero.prototype.jump = function(self,data) 
  if (data.ground_contact) then 
    data.velocity.y = self.jump_takeoff_speed;
  end;
end
Hero.prototype.abort_jump = function(self,data) 
  if (data.velocity.y > 0) then 
    data.velocity.y = data.velocity.y * 0.5;
  end;
end
Hero.__super__ = __defold_support_Script
setmetatable(Hero.prototype,{__index=__defold_support_Script.prototype})
...
Platform.prototype.init = function(self,data) 
  data.speed = 9;
  data.coins = ({});
end
Platform.prototype.final_ = function(self,data) 
  __lua_PairTools.ipairsEach(data.coins, function(i,p) 
    _G.go.delete(p);
  end);
end
Platform.prototype.update = function(self,data,dt) 
  local pos = _G.go.get_position();
  if (pos.x < -500) then 
...
Platform.prototype.on_message = function(self,data,message_id,message,sender) 
  ...
  elseif (message_id) == Messages.SetSpeed then 
    data.speed = _hx_funcToField(message.speed); end;
end
Platform.prototype.create_coins = function(self,data,coins) 
  local pos = _G.go.get_position();
  ...
  while (_g < coins) do 
    ...
    _G.msg.post(coin, __defold_GoMessages.set_parent, _hx_o({__fields__={parent_id=true},parent_id=_G.go.get_id()}));
    _G.msg.post(coin, Messages.StartAnimation, _hx_o({__fields__={delay=true},delay=i / 10}));
    _G.table.insert(data.coins, coin);
  end;
end
Platform.__super__ = __defold_support_Script
setmetatable(Platform.prototype,{__index=__defold_support_Script.prototype})
...
__defold_support_Init.init = function(exports) 
  local script = Ground.new();
  exports.Ground_init = function(data) 
    script:init(data);
  end;
  exports.Ground_update = function(data1,dt) 
    script:update(data1, dt);
  end;
  exports.Ground_on_message = function(data2,message_id,message,sender) 
    script:on_message(data2, message_id, message, sender);
  end;
  local script1 = Hero.new();
  exports.Hero_init = function(data3) 
    script1:init(data3);
  end;
  exports.Hero_final_ = function(_) 
    script1:final_(_);
  end;
  exports.Hero_update = function(data4,dt1) 
    script1:update(data4, dt1);
  end;
  exports.Hero_on_message = function(data5,message_id1,message1,sender1) 
    script1:on_message(data5, message_id1, message1, sender1);
  end;
  exports.Hero_on_input = function(data6,action_id,action) 
    do return script1:on_input(data6, action_id, action) end;
  end;
  local script2 = Controller.new();
  exports.Controller_init = function(data7) 
    script2:init(data7);
  end;
  exports.Controller_update = function(data8,dt2) 
    script2:update(data8, dt2);
  end;
  exports.Controller_on_message = function(data9,message_id2,message2,sender2) 
    script2:on_message(data9, message_id2, message2, sender2);
  end;
  local script3 = Platform.new();
  exports.Platform_init = function(data10) 
    script3:init(data10);
  end;
  exports.Platform_final_ = function(data11) 
    script3:final_(data11);
  end;
  exports.Platform_update = function(data12,dt3) 
    script3:update(data12, dt3);
  end;
  exports.Platform_on_message = function(data13,message_id3,message3,sender3) 
    script3:on_message(data13, message_id3, message3, sender3);
  end;
  local script4 = Coin.new();
  exports.Coin_init = function(data14) 
    script4:init(data14);
  end;
  exports.Coin_on_message = function(data15,message_id4,message4,sender4) 
    script4:on_message(data15, message_id4, message4, sender4);
  end;
end
