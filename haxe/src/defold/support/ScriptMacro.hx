...
class ScriptMacro {
    static function use() {
        Context.onGenerate(function(types) {
            ...
            if (baseScriptClass == null)
                throw "No base Script class found!";

            var baseScriptMethods = new Map();
            for (field in baseScriptClass.fields.get())
            ...
            for (script in scriptClasses) {
                ...
                // TODO: prevent duplicating classes, allow configurable script names
